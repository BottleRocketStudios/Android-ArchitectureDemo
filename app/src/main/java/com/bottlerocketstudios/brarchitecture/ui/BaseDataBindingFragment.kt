 ...
 *
 * 1. Pass in the associated fragment ViewModel (extending [BaseViewModel]) and Binding on the [BaseDataBindingFragment] subclass.
 ...
 */
abstract class BaseDataBindingFragment<FRAGMENT_VIEW_MODEL : BaseViewModel, BINDING : ViewDataBinding> : BaseFragment<FRAGMENT_VIEW_MODEL>() {
